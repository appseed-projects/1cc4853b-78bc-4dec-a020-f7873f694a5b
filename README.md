...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-08-16 18:28`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/1cc4853b-78bc-4dec-a020-f7873f694a5b.git
$ cd 1cc4853b-78bc-4dec-a020-f7873f694a5b
```
